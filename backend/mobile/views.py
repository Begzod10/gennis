...
def lesson_plan(plan_id):
    ...
    if request.method == "POST":
        ...
        lesson_target = get_json_field('lesson_target')
        assessment = get_json_field('assessment')
        main_lesson = get_json_field('main_lesson')
        new_homework = get_json_field('new_homework')
        lesson_plan_get.lesson_name = lesson_name,
        lesson_plan_get.lesson_target = lesson_target,
        lesson_plan_get.assessment = assessment,
        lesson_plan_get.main_lesson = main_lesson,
        lesson_plan_get.homework = new_homework
        db.session.commit()
